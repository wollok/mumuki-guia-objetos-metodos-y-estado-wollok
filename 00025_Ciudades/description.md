¡Ah! Pero también dijimos que `pepita` podía volar a diferentes ciudades: `buenosAires` y `rosario`. Y cuando lo hace, además de perder 100 unidades de energía, tiene que modificar el lugar donde se encuentra. 
